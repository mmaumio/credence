 ...
 * @return {Object} - this
 */
function _credThemeColor( backgroundColor, accentHue ) {
 ...
 * @return {Object} - this
 */
_credThemeColor.prototype.setAccentColorsArray = function() {
	var self = this,
		minSaturation = 65,
		maxSaturation = 100,
		minLightness = 30,
 ...
 */
_credThemeColor.prototype.getTextColor = function() {
 ...
 * @return {Color} - Returns a Color object.
 */
_credThemeColor.prototype.getAccentColor = function() {
	var fallback;
...
/**
 * Return a new instance of the _credThemeColor object.
 *
 * @since 1.0.0
 * @param {string} backgroundColor - The background color.
 * @param {number} accentHue - The hue for our accent color.
 * @return {Object} - this
 */
function credThemeColor( backgroundColor, accentHue ) {// jshint ignore:line
	var color = new _credThemeColor( backgroundColor, accentHue );
